...
opcion = st.selectbox(
    ...
    ('Área de un Círculo', 'Área de un Triángulo', 'Área de un Rectángulo',
     'Área de un Trapecio', 'Volumen de un Cubo', 'Volumen de una Esfera',
     'Volumen de un Cilindro', 'Volumen de un Cono')
)

# Interfaz de entrada y cálculo dependiendo de la opción seleccionada
if opcion == 'Área de un Círculo':
...
elif opcion == 'Área de un Rectángulo':
...
elif opcion == 'Área de un Trapecio':
...
elif opcion == 'Volumen de un Cubo':
...
elif opcion == 'Volumen de una Esfera':
...
elif opcion == 'Volumen de un Cilindro':
...
elif opcion == 'Volumen de un Cono':
